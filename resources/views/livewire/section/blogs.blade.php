                        ...
                        <div class="tm-blog wow fadeInUp">
                            @if(data_get($blog,'type')=="image")
                                <div class="tm-blog-image">
                                    {{dd([$blog,"category"=>data_get($blog,'category'),"slug"=>data_get($blog,'slug')])}}
                            ...
                            <div class="tm-blog-content">
                                ...
                                <h5><a href="{{route("blog.details",["category"=>data_get($blog,'category'),"slug"=>data_get($blog,'slug')])}}">{{data_get($blod,'title')}}</a></h5>
