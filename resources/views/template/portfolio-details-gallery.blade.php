        ...
        <div class="tm-breadcrumb-area tm-padding-section text-center" data-overlay="1" data-bgimage="/assets/images/bg/bg-breadcrumb.jpg">
            <div class="container">
                <div class="tm-breadcrumb">
                    <h2 class="tm-breadcrumb-title">Portfolio Details</h2>
                    <ul>
                        <li><a href="home.blade.php">Home</a></li>
                        <li><a href="portfolio.blade.php">Portfolio</a></li>
                        <li>New business idea platform</li>
                    </ul>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-xl-8 col-lg-7">
                                    <div class="tm-portfoliodetails-description">
                                        ...
                                        <ul class="stylish-list">
                                            <li><i class="fa fa-check-square"></i>Totam reiciendis enim adipisci odio
                                                laborum et ullam nihil quia.</li>
                                            <li><i class="fa fa-check-square"></i>Illum corrupti ut distinctio.</li>
                                            <li><i class="fa fa-check-square"></i>Debitis dolor a ut deserunt unde.
                                                Odit delectus similique.</li>
                                            <li><i class="fa fa-check-square"></i>Et quo consequuntur voluptas sit
                                                cumque distinctio.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
