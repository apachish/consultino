        ...
        <div class="tm-breadcrumb-area tm-padding-section text-center" data-overlay="1" data-bgimage="/assets/images/bg/bg-breadcrumb.jpg">
            <div class="container">
                <div class="tm-breadcrumb">
                    <h2 class="tm-breadcrumb-title">Blog Details</h2>
                    <ul>
                        <li><a href="home.blade.php">Home</a></li>
                        <li><a href="blog.blade.php">Blogs</a></li>
                            ...
                            <div class="tm-blog tm-blog-details sticky-sidebar">
                                <div class="tm-blog-image">
                                    <a href="blog-details.blade.php">
                                        <img src="/assets/images/blog/lg/blog-image-lg-1.jpg" alt="blog image">
                                    </a>
                                </div>
                                <div class="tm-blog-content">
                                    <div class="tm-blog-meta">
                                        <span><i class="fa fa-user-o"></i>By <a href="blog.blade.php">Anderson</a></span>
                                        <span><i class="fa fa-calendar-o"></i>October 15, 2018</span>
                                        <span><i class="fa fa-folder-o"></i><a href="blog.blade.php">Business</a></span>
                                    </div>
                                    <h3>The Most Advance Business Plan</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                        tempor incdidunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                        quis nostrud exercitation ullaco laboris nisi ut aliquip ex ea commodo
                                        consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
                                        cillum dolore eu fugiat nulla pariatur. Excepteur sint occaeca cupidatat
                                        non proident.</p>
                                    <p>There are many variations of passages of Lorem Ipsum available, but the
                                        majority have suffered alteration some form,
                                    ...
                                    <blockquote>
                                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Aliquam
                                            vulputate
                                            tortor nec commodo ultricies lectus nisl
                                            facilisis enim trpis.</p>
                                    </blockquote>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                        tempor incdidunt ut labore et dolore magna
                                        aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullaco laboris
                                        nisi ut aliquip ex ea commodo consequat.
                                        Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
                                        dolore eu fugiat nulla pariatur. Excepteur
                                        sint occaeca cupidatat non proident.</p>
                                </div>
                                <div class="tm-blog-tags">
                                    ...
                                    <ul>
                                        <li><a href="blog.blade.php">Apps</a></li>
                                        <li><a href="blog.blade.php">Development</a></li>
                                        <li><a href="blog.blade.php">Php</a></li>
                                        <li><a href="blog.blade.php">Web</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="tm-blog-pagination tm-pagination">
                                    <ul>
                                        <li>
                                            <a href="blog-details.blade.php">Previous Post</a>
                                        </li>
                                        <li>
                                            <a href="blog-details.blade.php">Next Post</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="tm-blog-commentbox mt-50">
                                    ...
                                    <form action="#" class="tm-commentbox">
                                        ...
                                        <div class="tm-commentbox-singlefield w-33">
                                            <label for="tm-comment-namefield">Name*</label>
                                            <input type="text" id="tm-comment-namefield">
                                        </div>
                                        <div class="tm-commentbox-singlefield w-33">
                                            <label for="tm-comment-email">Email*</label>
                                            <input type="email" id="tm-comment-email">
                                        </div>
                                        <div class="tm-commentbox-singlefield w-33">
                                            <label for="tm-comment-website">Website</label>
                                            <input type="text" id="tm-comment-website">
                                        </div>
                                        <div class="tm-commentbox-singlefield">
                                            <label for="tm-comment-textbox">Comment</label>
                                            <textarea name="tm-comment-textbox" id="tm-comment-textbox" cols="30" rows="7"></textarea>
                                        </div>
                                        <div class="tm-commentbox-singlefield">
                                            <button type="submit" class="tm-button">Post Comment <b></b></button>
                                        </div>
                                    </form>
                                </div>
                                <!--// tm-blog Commentbox -->
                        ...
                        <div class="col-lg-4 col-12 order-2 order-lg-1">
                            <div class="widgets sidebar-widgets sticky-sidebar">
                                ...
                                <div class="single-widget widget-categories">
                                    ...
                                    <ul>
                                        <li><a href="blog.blade.php">Business Report</a></li>
                                        <li><a href="blog.blade.php">Business Growth</a></li>
                                        <li><a href="blog.blade.php">Business Strategy</a></li>
                                        <li><a href="blog.blade.php">Financial Advise</a></li>
                                        <li><a href="blog.blade.php">Creative Idea</a></li>
                                        <li><a href="blog.blade.php">Marketing</a></li>
                                    </ul>
                                </div>
                                <!--// Single Widget -->
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="widget-recentpost-content">
                                                <h6><a href="blog-details.blade.php">Fundamental analysis
                                                        services</a></h6>
                                        ...
                                        <li>
                                            ...
                                            <div class="widget-recentpost-content">
                                                <h6><a href="blog-details.blade.php">Steps to a successful
                                                        Business</a></h6>
                                                <span>August 01, 2018</span>
                                            </div>
                                        </li>
                                ...
                                <div class="single-widget widget-archives">
                                    ...
                                    <ul>
                                        <li><a href="blog.blade.php">January 2018</a></li>
                                        <li><a href="blog.blade.php">March 2018</a></li>
                                        <li><a href="blog.blade.php">April 2018</a></li>
                                        <li><a href="blog.blade.php">July 2018</a></li>
                                        <li><a href="blog.blade.php">September 2018</a></li>
                                        <li><a href="blog.blade.php">October 2018</a></li>
                                    </ul>
                                </div>
                                <!--// Single Widget -->
                                ...
                                <div class="single-widget widget-tags">
                                    <h5 class="widget-title">Categories</h5>
                                    <ul>
                                        <li><a href="blog.blade.php">Business</a></li>
                                        <li><a href="blog.blade.php">Idea</a></li>
                                        <li><a href="blog.blade.php">Service</a></li>
                                        <li><a href="blog.blade.php">Clean</a></li>
                                        <li><a href="blog.blade.php">Marketing</a></li>
                                        <li><a href="blog.blade.php">Agency</a></li>
                                        <li><a href="blog.blade.php">Unique</a></li>
                                        <li><a href="blog.blade.php">Creative</a></li>
                                        <li><a href="blog.blade.php">Clear</a></li>
                                        <li><a href="blog.blade.php">Business Plan</a></li>
                                        <li><a href="blog.blade.php">Corporate</a></li>
                                    </ul>
                                </div>
                                <!--// Single Widget -->
                    ...
                    <div class="row align-items-center tm-cta">
                        ...
                        <div class="col-lg-3 col-md-4 col-12">
                            <div class="tm-cta-button">
                                <a href="contact-us.blade.php" class="tm-button tm-button-white">Contact Us <b></b></a>
                            </div>
                        </div>
                    </div>
                </div>
