        ...
        <div class="tm-breadcrumb-area tm-padding-section text-center" data-overlay="1" data-bgimage="/assets/images/bg/bg-breadcrumb.jpg">
            <div class="container">
                <div class="tm-breadcrumb">
                    <h2 class="tm-breadcrumb-title">Product Details</h2>
                    <ul>
            ...
            <div class="tm-section product-details-area bg-white tm-padding-section">
                <div class="container">
                    <div class="row">
                                ...
                                <div class="row">
                                        ...
                                        <div class="tm-prodetails-images">
                                            <div class="tm-prodetails-largeimages">
                                                <div class="tm-prodetails-largeimage">
                                                    <a href="/assets/images/product/product-lg/product-image-lg-1.jpg">
                                                        <img src="/assets/images/product/product-image-1.jpg" alt="product image">
                                                    </a>
                                                </div>
                                                <div class="tm-prodetails-largeimage">
                                                    <a href="/assets/images/product/product-lg/product-image-lg-2.jpg">
                                                        <img src="/assets/images/product/product-image-2.jpg" alt="product image">
                                                    </a>
                                                </div>
                                                <div class="tm-prodetails-largeimage">
                                                    <a href="/assets/images/product/product-lg/product-image-lg-3.jpg">
                                                        <img src="/assets/images/product/product-image-3.jpg" alt="product image">
                                                    </a>
                                                </div>
                                                <div class="tm-prodetails-largeimage">
                                                    <a href="/assets/images/product/product-lg/product-image-lg-4.jpg">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="tm-prodetails-content">
                                            <h3 class="tm-prodetails-title">Business Strategy</h3>
                                            <div class="tm-rating">
                                            ...
                                            <div class="tm-prodetails-color">
                                                <h6>Color :</h6>
                                                <ul>
                                                    <li class="red is-checked"><span></span></li>
                                            ...
                                            <div class="tm-prodetails-size">
                                                <h6>Size :</h6>
                                                <ul>
                                                    <li class="is-checked"><span>S</span></li>
                                                    <li><span>M</span></li>
                                                    <li><span>L</span></li>
                                                    <li><span>XL</span></li>
                                                    <li><span>XXL</span></li>
                                    ...
                                    <div class="tab-content" id="prodetails-content">
                                        <div class="tab-pane fade show active" id="prodetails-area1" role="tabpanel"
                                            ...
                                            <div class="tm-prodetails-description">
                                                <p>Dolorum excepturi eos vitae illo at. Quidem id laboriosam
                                                    ullam
                                                    aspernatur ut dolorem at. Ex dicta sed praesentium.
                                                    Deserunt est aut
                                                    neque. Enim laborum mollitia dicta quidem in rem. Totam
                                                    natus debitis
                                                    ab eaque iste dolorum.</p>
                                                <p>Rem facilis placeat et. Perspiciatis modi quaerat quis in
                                                    sit odit.
                                                    Autem neque ipsum id. Fuga qui quia. Ut possimus voluptates
                                                    vel
                                                    deserunt praesentium totam doloremque enim. Rerum facilis
                                                    in.</p>
                                                <ul>
                                                    <li><b>Brand Name:</b> ABCD</li>
                                                    <li><b>Model:</b> ABCD band 3</li>
                                                    <li><b>Language:</b>
                                        ...
                                        <div class="tab-pane fade" id="prodetails-area2" role="tabpanel"
                                            ...
                                            <div class="tm-prodetails-review">
                                                <h5 class="text-uppercase">2 Reviews For Business Strategy</h5>
                                                <div class="tm-comment-wrapper mb-50">

                                                    <!-- Comment Single -->
                                                    <div class="tm-comment">
                                                        <div class="tm-comment-thumb">
                                                            <img src="/assets/images/authors/author-image-1.jpg"
                                                                alt="author image">
                                                        </div>
                                                        <div class="tm-comment-content">
                                                            <h6 class="tm-comment-authorname"><a href="#">Kirstin Lehner</a></h6>
                                                            <span class="tm-comment-date">Wednesday, October
                                                                17, 2018 at
                                                                4:00PM.</span>
                                                            <div class="tm-rating">
                                                                <span class="active"><i class="fa fa-star"></i></span>
                                                            ...
                                                            <p>Nostrum consectetur voluptatum. Error cupiditate voluptas inventore labore harum laboriosam tempore sunt. Dicta ut natus et rerum dolorum in sit odio quidem.</p>
                                                        </div>
                                                    </div>
                                                    <!--// Comment Single -->
                                                    ...
                                                    <div class="tm-comment">
                                                        <div class="tm-comment-thumb">
                                                            <img src="/assets/images/authors/author-image-2.jpg"
                                                                alt="author image">
                                                        </div>
                                                        <div class="tm-comment-content">
                                                            <h6 class="tm-comment-authorname"><a href="#">Dell Douglas</a></h6>
                                                            <span class="tm-comment-date">Wednesday, October
                                                                17, 2018 at
                                                                4:00PM.</span>
                                                            <div class="tm-rating">
                                                            ...
                                                            <p>Nostrum voluptatem velit quasi deleniti optio et. Mollitia voluptas aut. Ea in eos inventore illum officia qui labore dolore consequatur.</p>
                                                        </div>
                                                    </div>
                                                    <!--// Comment Single -->
                        ...
                        <div class="col-lg-3">
                            <div class="widgets sidebar-widgets-2 sticky-sidebar">

                                <!-- Single Widget -->
                                <div class="single-widget widget-relatedproduct">
                                    <h5 class="widget-title">Related Product</h5>
                                    <ul>
                                        <li>
                                            <a href="product-details.blade.php" class="widget-popularproduct-image">
                                                <img src="/assets/images/product/product-thumbnail/product-image-1.jpg"
                                                    alt="product thumbnail">
                                            </a>
                                            <div class="widget-popularproduct-content">
                                                <h6><a href="product-details.blade.php">Business Strategy</a></h6>
                                                <span>$20.00</span>
                                        ...
                                        <li>
                                            ...
                                            <div class="widget-popularproduct-content">
                                                <h6><a href="product-details.blade.php">Thives of Business</a></h6>
                                                <span>$35.99</span>
                                                <div class="tm-product-rating">
                                                    <span class="active"><i class="fa fa-star"></i></span>
                                                    <span class="active"><i class="fa fa-star"></i></span>
                                        ...
                                        <li>
                                            ...
                                            <div class="widget-popularproduct-content">
                                                <h6><a href="product-details.blade.php">Best Carrer</a></h6>
                                                <span>$99.99</span>
                                                <div class="tm-product-rating">
                                                    <span class="active"><i class="fa fa-star"></i></span>
                                                    <span class="active"><i class="fa fa-star"></i></span>
