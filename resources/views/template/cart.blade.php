        ...
        <div class="tm-breadcrumb-area tm-padding-section text-center" data-overlay="1" data-bgimage="/assets/images/bg/bg-breadcrumb.jpg">
            <div class="container">
                <div class="tm-breadcrumb">
                    <h2 class="tm-breadcrumb-title">Shopping Cart</h2>
                    <ul>
                    ...
                    <div class="tm-cart-table table-responsive">
                        <table class="table table-bordered mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="product-details.blade.php" class="tm-cart-productimage">
                                            <img src="/assets/images/product/product-image-1.jpg" alt="product image">
                                        </a>
                                    </td>
                                    <td>
                                        <a href="product-details.blade.php" class="tm-cart-productname">Latest Smartwatch
                                            H-250
                                            2018</a>
                                    </td>
                                    ...
                                    <td>
                                        <button class="tm-cart-removeproduct"><i class="fa fa-times"></i></button>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <a href="product-details.blade.php" class="tm-cart-productname">Awesome Minimal
                                            Flower Tub</a>
                                    </td>
                                    <td class="tm-cart-price">$75.00</td>
                                    <td>
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-6">
                                <div class="tm-buttongroup">
                                    <a href="shop.blade.php" class="tm-button">Continue Shopping <b></b></a>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="tm-cart-pricebox">
                                    ...
                                    <a href="checkout.blade.php" class="tm-button">Proceed To Checkout <b></b></a>
                                </div>
                            </div>
                        </div>
                    </div>
